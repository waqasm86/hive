...
- **aden_tools** - 106 инструментов MCP для возможностей агентов
...
├── tools/                  # Пакет инструментов MCP - 106 инструментов для возможностей агентов
...
# - пакет aden_tools (106 инструментов MCP)
# - Все зависимости
